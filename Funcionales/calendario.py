            ...
            if calendario[fecha][equipo_local - 1] == 0:
                ...
                for _ in range(partidos_positivos):
                    ...
                    if equipos_contrincantes:
                        equipo_contrincante = min(equipos_contrincantes, key=lambda e: distancias[ultimo_equipo - 1][e - 1] if ultimo_equipo else distancias[equipo_local - 1][e - 1])
                        ultimo_equipo=equipo_contrincante
...
if __name__ == "__main__":
    ...
    output_text = tk.Text(root, height=30, width=80)
